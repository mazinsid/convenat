...
<html>
    <head>
        ...
        <title>عهد اجزة الاتصالات</title>
            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        <div>
                            <img class="w-16 h-16 rounded-full mx-auto" src="" />
                       
                        </div>
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">عهد اجزة الاتصالات</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">{{__('tables.email')}}</div>
                                <input  class="w-full text-lg py-2 border-b border-gray-300 
                                focus:outline-none focus:border-indigo-500 @error('email') border-red-500 @enderror"
                                 for="email" id="email" name="email"
                                required type="email" placeholder="{{__('tables.email')}}">
                            </div>
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300
                                 focus:outline-none focus:border-indigo-500 border-red-500 " 
                                 for="passowrd" id="passowrd" name="password"
                                 required type="password" placeholder="{{__('tables.password')}}">
                            </div>
                            <div class="mt-10">
