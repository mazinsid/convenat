          ...
          @if (auth()->user()->IsAdmin())
           ...
           <ul class="htmlCss-sub-menu sub-menu">
            ...
            <ul class="js-sub-menu sub-menu">
                ...
                <li><a href="{{route('DeviceRoute_index')}}">{{__('ar.routers')}}</a></li>
            ...
            <li class="more">
                ...
                <ul class="more-sub-menu sub-menu">
                  ...
                  <li><a href="{{route('CovenantSimCards_index')}}">{{__('ar.sim')}}</a></li>
                  <li><a href="{{route('CovenantDeviceRoute_index')}}">{{__('ar.routers')}}</a></li>
               ...
               <li><a href="{{route('users_index')}}">{{__('ar.menus_users')}}</a></li>
                  ...
                  <li> <a href="{{ route('logout') }}"
                    ...
                    onclick="event.preventDefault();
                         document.getElementById('logout-form').submit();">{{ __('ar.menus_logout') }}</a>
