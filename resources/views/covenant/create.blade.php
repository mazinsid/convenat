     ...
     <div class="card-body">
                      <form action="{{route('covenant_store')}}" method="POST">
                          ...
                          <div class="text-center">
                            ...
                            <div class="col-md-4 ">
                                <label for="name"  >{{__('tables.code')}}</label></div>
                                  <div class="col-sm-8">
                          ...
                          <div class="row col-12">
                          <div class="col-md-6">
                                  <div class="form-group" id="branchesload" >
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <div  id="car" style="display: none" >
                                          ...
                                          <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-form-label-sm" for="name"  >{{__('tables.plate_number')}}</label>
