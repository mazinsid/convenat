...
class AccessoryController extends Controller
{
    ...
    {
        return view('accessory.index')->with('accessores', accessory::all())->with('types',ptype::all());
    }
    ...
    public function store(Request $request)
    {
        accessory::create([
           ...
           'ptype_id' => $request->type_id, //This ptype_id coming from ajax request
         ]);

         session()->flash('status','تم الادخال بنجاح');
         return redirect(route('accessory_index'));
    }
